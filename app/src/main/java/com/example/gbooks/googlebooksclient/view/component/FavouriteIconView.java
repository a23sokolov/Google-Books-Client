...
public class FavouriteIconView extends android.support.v7.widget.AppCompatTextView{
    private static final String FONT_PATH = "fonts/MaterialIcons-Regular.ttf";
    private final Typeface materialFont;
    public FavouriteIconView(Context context) {
        super(context);
        materialFont = Typeface.createFromAsset(context.getAssets(), FONT_PATH);
        setTypeface(materialFont);
    }

    public FavouriteIconView(Context context, AttributeSet attrs) {
        super(context, attrs);
        materialFont = Typeface.createFromAsset(context.getAssets(), FONT_PATH);
        setTypeface(materialFont);
    }

    public FavouriteIconView(Context context, AttributeSet attrs, int defStyleAttr) {
